...
class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.player = this.physics.add.sprite(mapWidth / 2, mapHeight / 2, 'player').setScale(0.05).setCollideWorldBounds(true);
    ...
    this.hpText = this.add.text(110, 100, 'HP: 100', { fontSize: '16px', fill: '#FFFFFF', shadow: { offsetX: 2, offsetY: 2, color: '#000', blur: 2, fill: true } }).setOrigin(0.5).setScrollFactor(0);
